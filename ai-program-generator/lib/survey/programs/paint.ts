...
export const paint: ProgramType = {
  ...
  steps: [
    ...
    // STEP 2 — 붓 종류
    {
      ...
      options: [
        ...
        },
        {
          ...
          label: '빈 종이에 자유롭게',
          icon: '📄',
          promptFragment: '밑그림 없는 빈 도화지에 자유롭게 그리게 해.',
        },
      ],
    },
    {
    ...
    // STEP 3 — 무지개 모드 (brush=crayon일 때만) [Chain Level 1]
    {
      ...
      options: [
        ...
        },
        {
          ...
          label: '아니, 한 색으로',
          icon: '🎯',
          promptFragment: '무지개색 전환 없이 선택한 한 색으로 그리게 해.',
        },
      ],
    },
    ...
    // STEP 6 — 붓 굵기
    {
      ...
      options: [
        ...
        },
        {
          ...
          label: '아니, 그냥 그대로',
          icon: '✋',
          promptFragment: '굵기 조절 슬라이더·버튼 없이 기본 굵기로만 그리게 해.',
        },
      ],
    },
    ...
    // STEP 8 — 도장 (multi)
    {
      ...
      options: [
        ...
        },
        {
          ...
          label: '없어도 돼',
          icon: '🚫',
          promptFragment: '동물·별·꽃·공룡·유니콘 도장을 넣지 마.',
          exclusive: true,
        },
      ],
    },
    ...
    // STEP 10 — 이름 도장 (stamp에 none이 없고 선택이 있을 때) [Conditional]
    {
      ...
      options: [
        ...
        },
        {
          ...
          label: '아니, 그냥 도장만',
          icon: '🚫',
          promptFragment: '이름을 적어 찍는 텍스트 도장을 넣지 마.',
        },
      ],
    },
    // STEP 11 — 배경 음악
    {
      ...
      options: [
        ...
        },
        {
          ...
          label: '조용하게',
          icon: '🔇',
          promptFragment: '배경음·그릴 때 나는 효과음을 넣지 마.',
        },
      ],
    },
    ...
    // STEP 13 — 저장. 미리보기 iframe의 보안 정책상 Clipboard API는 사용할 수 없으므로
    // 아이가 고를 수 있는 출력 방식도 실제로 작동하는 PNG 다운로드로 통일한다.
    {
      id: 'save',
      role: 'output',
      question: '내 그림을 PNG 파일로 저장할까?',
      options: [
        {
          id: 'download',
          label: 'PNG로 저장하기',
        ...
        },
        {
          ...
          label: '아니, 그냥 그리기만',
          icon: '🖼️',
          promptFragment: '저장·복사·공유 버튼 없이 그리기 기능만 넣어.',
        },
      ],
    },
  ],
