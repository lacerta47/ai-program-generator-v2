    ...
    // Step 6 — 우주 추가 효과 (theme==='space', Chain A)
    {
      ...
      options: [
        ...
        },
        {
          ...
          label: '아니, 별만',
          icon: '⭐',
          promptFragment: '좋아하는 것을 별도 항목으로 추가하지 마.',
        },
      ],
    },
    ...
    // Step 8 — 꾸밈 움직임 (deco가 하나라도 선택됐을 때)
    {
      ...
      options: [
        ...
        },
        {
          ...
          label: '그냥 가만히',
          icon: '🤫',
          promptFragment: '카드 요소를 자동으로 움직이거나 흔드는 애니메이션을 넣지 마.',
        },
      ],
    },
    ...
    // Step 9 — 카드 클릭 효과
    {
      ...
      options: [
        ...
        },
        {
          ...
          label: '효과 없이',
          icon: '🙅',
          promptFragment: '카드를 눌러도 반짝임·하트·흔들림 같은 클릭 효과를 넣지 마.',
        },
      ],
    },
      ...
      options: [
        {
          ...
          label: '응, 짧은 멜로디',
          icon: '🎵',
          promptFragment: '사용자가 카드 열기 버튼을 누른 직후 Web Audio API로 밝고 짧은 멜로디가 나게 해. 페이지 로드 중에는 재생하지 마.',
        },
        {
          id: 'click',
          label: '누를 때 소리',
        ...
        },
        {
          ...
          label: '조용하게',
          icon: '🔇',
          promptFragment: '멜로디·클릭음·효과음을 넣지 마.',
        },
      ],
    },
    ...
    // Step 12 — 이름 칸
    {
      ...
      options: [
        ...
        },
        {
          ...
          label: '아니, 그림만',
          icon: '🖼️',
          promptFragment: '사진 첨부·사진 영역을 넣지 마.',
        },
      ],
    },
