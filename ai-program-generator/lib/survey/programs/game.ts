    ...
    // STEP 10 — 파워업 (액션 장르만, multi)
    {
      ...
      options: [
        ...
        },
        {
          ...
          label: '없어도 돼',
          icon: '🚫',
          promptFragment: '보호막·시간 느려짐·점수 두 배·놀람 상자 같은 파워업을 넣지 마.',
          exclusive: true,
        },
      ],
    },
      ...
      options: [
        {
          ...
          icon: '✏️',
          needsName: true,
          promptFragment: '게임 시작 전 이름을 입력하고, 이름과 현재 실행의 최고 점수를 화면 안 점수판에 보여줘. 새로고침하면 기록은 초기화돼.',
        },
        {
          id: 'no',
          label: '아니, 그냥 점수만',
          icon: '📊',
          promptFragment: '이름 입력·이름 점수판 없이 점수만 보여줘.',
        },
      ],
    },
    // STEP 15 — 게임 오버
    {
      ...
      options: [
        ...
        },
        {
          ...
          label: '최고 점수도 기록',
          icon: '🏆',
          promptFragment: '게임 오버 화면에 최종 점수, 현재 실행 중의 최고 점수, 다시하기 버튼을 보여줘. 새로고침하면 최고 점수는 초기화돼.',
        },
        {
          id: 'praise',
          label: '점수 + 칭찬 메시지',
