    ...
    // Step 1 — kind (A in the A→B→C chain)
    {
      ...
      options: [
        ...
        },
        {
          ...
          icon: '💪',
          promptFragment:
            '응원 메시지 뽑기야. 예시: "포기하지 마, 할 수 있어!", "지금 이 순간도 잘 하고 있어!", "힘들 때일수록 더 강해져!", "한 걸음씩 앞으로!", "넌 이미 충분히 잘 하고 있어!", "오늘도 최선을 다해!", "실수해도 괜찮아, 다시 하면 돼!", "네 꿈을 믿어봐!", "조금만 더 힘내!", "넌 분명히 해낼 거야!", "멈추지 마 넌 잘 하고 있어!", "어렵더라도 끝까지!", "오늘 힘냈다면 충분해!", "내일은 더 잘될 거야!", "용기 내봐!", "넌 이미 용감해!", "잘 모르는 거 물어봐도 괜찮아!", "실패가 경험이 돼!", "천천히 해도 돼!", "함께라면 더 잘 될 거야!" 등으로 채워줘.',
        },
        {
          id: 'fact',
          label: '재미있는 사실',
